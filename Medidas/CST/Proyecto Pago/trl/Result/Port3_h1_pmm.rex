...
<MetaResultFile creator="FE Port mode solver" version="20170330">
  ...
  <SimulationProperties dB_Amplitude="20" encoded_unit="&amp;U:A^1.:m^-1" fieldname="&lt;name missing&gt;" fieldtype="H-Field" frequency="0" label="Port3 h1"/>
  <MetaGeometryFile filename="" lod="1"/>
  <ResultGroups num_steps="2">
    <Frame index="0" characteristic="15.5" tfo="Port3_h1_pmm_15.5.tfo">
      <FieldResultFile filename="Port3_h1(#0000).sct" meshname="Port3.slim" type="sct"/>
    </Frame>
    <Frame index="1" characteristic="1" tfo="Port3_h1_pmm_1.tfo">
      <FieldResultFile filename="Port3_h1(#0004).sct" meshname="Port3.slim" type="sct"/>
    </Frame>
  </ResultGroups>
